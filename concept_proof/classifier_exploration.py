...
def __main__():
    ...
    prompt3 = "Where is Abu Ahmed al-Kuwaiti from?"clair, Aurelio Beltrán, Elliot Patrick Benson,and Basil al-Kuwaiti related?"

    prompt4 = "Are Jaime Vasquez, Chukwu Akabueze, Anara Yusifova, Jordan Sin
